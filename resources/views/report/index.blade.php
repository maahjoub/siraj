                ...
                <div class="card-body text-center">
                   <div class="row">
                        ...
                        <div class="col-md-4 m-1 alert alert-warning">
                            ...
                            <a class="text-decoration-none text-warning" href="{{ route('all.boy') }}"> <span class="count">{{ $remind }}</span></a>
                        </div>
                        <div class="col-md-4 m-1 alert alert-danger">
                            <h3>اجمالي التخفيض  </h3>
                            <a class="text-decoration-none text-danger" href="{{ route('all.boy') }}"> <span class="count">{{ $discount }}</span></a>
                        </div>
